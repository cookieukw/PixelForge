...
export const pt: Translation = {
    ...
    animations: {
        ...
        flash: "O elemento pisca repetidamente, alternando entre visível e invisível.",
        ...
        wobble: "O elemento se move para frente e para trás com uma oscilação exagerada.",
        ...
        lightSpeedInRight: "O elemento entra rapidamente da direita, como um flash.",
        lightSpeedInLeft: "O elemento entra rapidamente da esquerda, como um flash.",
        lightSpeedOutRight: "O elemento sai rapidamente para a direita, como um flash.",
        lightSpeedOutLeft: "O elemento sai rapidamente para a esquerda, como um flash.",
        ...
        slideOutLeft: "O elemento desliza da esquerda para a direita ao desaparecer.",
        slideOutRight: "O elemento desliza da direita para a esquerda ao desaparecer.",
